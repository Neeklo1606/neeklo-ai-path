    ...
    <>
      ...
      <a
        ...
        style={{
          ...
          borderRadius: 16,
          background: hovered
            ? "linear-gradient(135deg, #2AABEE 0%, #1E96D1 100%)"
            : "linear-gradient(135deg, #229ED9 0%, #1B8DC2 100%)",
          color: "#fff",
          fontSize: 15,
          fontWeight: 600,
          textDecoration: "none",
          boxShadow: hovered
            ? "0 12px 36px rgba(34,158,217,0.45), 0 4px 12px rgba(0,0,0,0.15)"
            : "0 8px 24px rgba(34,158,217,0.3), 0 2px 8px rgba(0,0,0,0.1)",
